...
export default {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        const reply = await interactionUtils.createLeaderboardReply(interaction, team, { page: 0, pageSize: DEFAULT_LEADERBOARD_PAGE_SIZE, statsScope: StatsScope.REGIONAL, statsType: StatsType.TEAMS })
