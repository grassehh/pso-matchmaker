...
import { LINEUP_TYPE_SOLO, LINEUP_VISIBILITY_TEAM, teamService } from "../../services/teamService";

export default {
    data:
        new SlashCommandBuilder()
            .setName('lineup_create_solo_queue')
            .setDescription('Setup a solo queue lineup')
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        const lineup = teamService.createLineup(interaction.channelId, lineupSize, undefined, false, ranked, team, LINEUP_TYPE_SOLO, LINEUP_VISIBILITY_TEAM, false)
        ...
        reply.embeds?.splice(0, 0, interactionUtils.createInformationEmbed('✅ New solo queue lineup configured', interaction.user))
